...
public class Archer extends Unit{
    ...
    public Archer(float x, float y, float damage, float health, Vector2 target) {
        super(x, y, "characters/units/archer.atlas", damage, health, 50.0f, 500.0f);
        this.type = Globals.UnitType.ARCHER;
        this.target = target;
